/* @ts-self-types="./rust_demo_wasm.d.ts" */
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./rust_demo_wasm_bg.js": import0,
    };
}

const FractalEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_fractalengine_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rust_demo_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
